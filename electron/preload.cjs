...
contextBridge.exposeInMainWorld('fitbit', Object.freeze({
  ...
  getLifestyleData: () => ipcRenderer.invoke('fitbit:get-lifestyle-data'),
  saveLifestyleProfile: (profile) => ipcRenderer.invoke('fitbit:save-lifestyle-profile', profile),
  saveCaffeineEntries: (date, entries) => ipcRenderer.invoke('fitbit:save-caffeine-entries', date, entries),
